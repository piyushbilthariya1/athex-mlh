      ...
      <div className="hidden lg:flex lg:w-1/2 bg-[#181715] p-12 flex-col justify-between relative overflow-hidden select-none border-r border-white/5">
        ...
        <div className="relative z-10">
          ...
          <h2 className="font-serif text-[46px] tracking-[-1px] text-[var(--color-on-dark)] leading-[1.15] max-w-[420px] font-medium">
            Re-initialize your secure session.
          </h2>
          <p className="mt-6 font-sans text-[15.5px] text-[var(--color-on-dark-soft)] max-w-[400px] leading-relaxed">
            Access the analyst matrix. All document extractions and vectors remain isolated within your private environment.
          </p>

          {/* Secure Handshake Console Widget */}
          <div className="border border-white/10 bg-white/[0.02] p-6 rounded-2xl max-w-[400px] mt-12 font-mono text-[13px] text-white/70 leading-relaxed shadow-xl backdrop-blur-sm">
            <div className="flex items-center gap-1.5 mb-4 text-[10px] uppercase tracking-widest text-white/30 font-sans font-bold">handshake protocol</div>
            <div className="text-[#5db8a6]">► Initializing secure session keys...</div>
            <div className="text-[#5db8a6]">► Grounding factor temp = 0.2</div>
            <div className="text-[#cc785c] animate-pulse">► Awaiting operator credentials...</div>
          </div>
        </div>
        ...
        <div className="w-full max-w-[420px] relative z-10">
          ...
          <div className="mb-10">
            ...
            <p className="font-sans text-[14.5px] text-[var(--color-muted)]">
              Enter your credentials to access the analyst matrix.
            </p>
          </div>
          ...
          <p className="mt-8 text-center font-sans text-[14px] text-[var(--color-muted)]">
            ...
            <Link href="/signup" className="text-[var(--color-primary)] hover:underline font-semibold transition-all">
              Request access
            </Link>
          </p>
        </div>
